#!/usr/bin/env python3
"""
v9_agent.py - Mini Claude Code: 24 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks + Background Tasks + Agent Teams + Team Protocols

v8_agent + Team Protocols
===================================
...
def main():
    ...
    print(f"Mini Claude Code v9 (24 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks + Background Tasks + Agent Teams + Team Protocols) - {WORKDIR}")
