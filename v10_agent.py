#!/usr/bin/env python3
"""
v10_agent.py - Mini Claude Code: 26 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks + Background Tasks + Agent Teams + Team Protocols + Autonomous Agents

v9_agent + Autonomous Agents
===================================

v9_agent: 24 tools + shutdown_request + shutdown_response + plan_approval
...
identity re-injection after context compression.
    ...
    Teammate lifecycle:
    spawn -> WORK -> idle tool -> IDLE (poll 5s, timeout 60s)
                                    -> inbox msg? -> WORK
...
# =============================================================================
# TeammateManager with shutdown + plan approval protocols
# =============================================================================
...
- claim_task: claim a task from the shared board (.sessions/.../board/)
...
BASE_TOOLS = [
    ...
    {"name": "workspace_write", "description": "Write a file to the session workspace (for AI intermediate outputs). Path is relative to workspace/.",
     "input_schema": {"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}}, "required": ["path", "content"]}},
...
def main():
    ...
    print(f"Mini Claude Code v10 (26 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks + Background Tasks + Agent Teams + Team Protocols + Autonomous Agents) - {WORKDIR}")
