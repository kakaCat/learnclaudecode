#!/usr/bin/env python3
"""
v7_agent.py - Mini Claude Code: 16 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks + Background Tasks

v6_agent + Background Task System
===================================

v6_agent: 14 tools + Task + Skill Loading + Three-layer context compaction + Persistent TaskManager
v7_agent: 16 tools + background_run + check_background

Background tasks run in threads. Notifications are drained before each LLM call.
...
def main():
    ...
    print(f"Mini Claude Code v7 (16 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks + Background Tasks) - {WORKDIR}")
