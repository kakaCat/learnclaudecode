#!/usr/bin/env python3
"""
v6_agent.py - Mini Claude Code: 14 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks

v5_agent + Persistent Task System
===================================
...
def main():
    ...
    print(f"Mini Claude Code v6 (14 Tools + Todos + Subagents + Skills + Compaction + Persistent Tasks) - {WORKDIR}")
