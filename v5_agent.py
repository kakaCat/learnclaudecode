#!/usr/bin/env python3
"""
v5_agent.py - Mini Claude Code: 10 Tools + Todos + Subagents + Skills + Compaction

v4_agent + Context Compaction
==============================

v4_agent:  9 tools + Task + Skill Loading
v5_agent: 10 tools + Task + Skill Loading + Three-layer context compaction
...
BASE_TOOLS = [
    {"name": "bash", "description": "Run a shell command. Use for: git, npm, python, running tests. NOT for file exploration (use glob/grep/list_dir).",
    ...
    {"name": "glob", "description": "Find files matching a pattern. Examples: '**/*.py', 'src/**/*.ts'",
    ...
    {"name": "TodoWrite", "description": "Update the task list. Use to plan and track progress.",
    ...
    {"name": "load_skill", "description": "Load specialized knowledge by name. Call before tackling unfamiliar topics.",
...
def get_tools_for_agent(agent_type: str) -> list:
    """Filter tools for subagents. Subagents never get Task or compact."""
...
def main():
    ...
    print(f"Mini Claude Code v5 (10 Tools + Todos + Subagents + Skills + Compaction) - {WORKDIR}")
