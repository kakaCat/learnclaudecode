#!/usr/bin/env python3
"""
v5_agent.py - Mini Claude Code: 9 Tools + Todos + Subagents + Skills

v4_agent + Skill Loading
========================

v4_agent:  8 tools + Task (subagents with isolated context)
v5_agent:  9 tools + Task + Skill Loading (two-layer injection)
...
Skills are stored in .skills/*.md files with YAML frontmatter:
    ---
...
def main():
    ...
    print(f"Mini Claude Code v5 (9 Tools + Todos + Subagents + Skills) - {WORKDIR}")
